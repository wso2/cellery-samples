...
refer [here](https://github.com/wso2/cellery/blob/v0.6.0/docs/cli-reference.md#cellery-run).
```
...
```
 ...
 ---------- -------------------------------- -------- ------------------------- ------------ ---------------------
  pet-be     wso2cellery/pet-be-cell:0.6.0   Ready    pet-be--gateway-service   4            2 hours 47 minutes
  pet-fe     wso2cellery/pet-fe-cell:0.6.0   Ready    pet-fe--gateway-service   1            3 hours 16 minutes
```
3. Now view the application by following the [instructions](#view-application).

## View application 
Make sure you have configured the host entries correctly as mentioned in [local](https://github.com/wso2/cellery/blob/v0.6.0/docs/setup/local-setup.md), 
[gcp](https://github.com/wso2/cellery/blob/v0.6.0/docs/setup/gcp-setup.md#configure-host-entries) and [existing setup](https://github.com/wso2/cellery/blob/v0.6.0/docs/setup/existing-cluster.md#configure-host-entries) before
...
Cellery observability mainly supported by [Cellery Dashboard](https://github.com/wso2/cellery/blob/v0.6.0/docs/cellery-observability.md#use-cellery-dashboard). 

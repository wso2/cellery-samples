...
public function build(cellery:ImageName iName) returns error? {
    ...
    cellery:Component ordersComponent = {
        name: "orders",
        source: {
            image: "wso2cellery/samples-pet-store-orders:0.3.0"
        },
        ingresses: {
    ...
    cellery:Component customersComponent = {
        name: "customers",
        source: {
            image: "wso2cellery/samples-pet-store-customers:0.3.0"
        },
        ingresses: {
    ...
    cellery:Component catalogComponent = {
        name: "catalog",
        source: {
            image: "wso2cellery/samples-pet-store-catalog:0.3.0"
        },
        ingresses: {
    ...
    cellery:Component controllerComponent = {
        name: "controller",
        source: {
            image: "wso2cellery/samples-pet-store-controller:0.3.0"
        },
        ingresses: {

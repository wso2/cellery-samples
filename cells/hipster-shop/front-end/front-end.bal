...
public function build(cellery:ImageName iName) returns error? {
    ...
    cellery:Component frontEndComponent = {
        ...
        dependencies: {
            cells: {
                productsCellDep: <cellery:ImageName>{ org: "wso2cellery", name: "products-cell", ver: "0.4.0"},
                adsCellDep: <cellery:ImageName>{ org: "wso2cellery", name: "ads-cell", ver: "0.4.0"},
                cartCellDep: <cellery:ImageName>{ org: "wso2cellery", name: "cart-cell", ver: "0.4.0"},
                checkoutCellDep: <cellery:ImageName>{ org: "wso2cellery", name: "checkout-cell", ver: "0.4.0"}
            }
        }
    };

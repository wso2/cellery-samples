...
Let us assume the pet-be instance's controller component should be updated with docker image `wso2cellery/samples-pet-store-controller:0.5.0v2`. 

1) Patch the currently running `pet-be` instance's controller component with below command.
```
$ cellery patch pet-be controller --container-image wso2cellery/samples-pet-store-controller:0.5.0v2
```
...
Refer to [CLI docs](https://github.com/wso2-cellery/sdk/blob/v0.5.0/docs/cli-reference.md#cellery-patch) for a complete guide on performing updates on cell instances.
...
1) You can optionally build cell with `wso2cellery/pet-be-auto-scale-cell:0.5.0` from cell file [pet-be-auto-scale.bal](../../cells/pet-store/advanced/pet-be-auto-scale/pet-be-auto-scale.bal) 
...
```
$ cellery run wso2cellery/pet-be-auto-scale-cell:0.5.0 -n pet-be-as
```
...
Refer to [CLI docs](https://github.com/wso2-cellery/sdk/blob/v0.5.0/docs/cli-reference.md#cellery-route-traffic) for a complete guide on route-traffic for cell instances.

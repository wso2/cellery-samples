...
```
$ cellery run wso2cellery/pet-fe-cell-to-composite:0.6.0 -n pet-fe-comp-cell -l petStoreBackend:pet-be-comp -d
```
...
1. Build the cell image for pet-store project by executing the `cellery build` command as shown below. Note `CELLERY_HUB_ORG` is your organization name in [Cellery hub](https://hub.cellery.io/).
    ```
    $ cellery build pet-be-composite.bal <CELLERY_HUB_ORG>/pet-be-composite:0.6.0
    Hello World Cell Built successfully.
    
    ✔ Building image <CELLERY_HUB_ORG>/pet-be-composite:0.6.0
    ✔ Saving new Image to the Local Repository
    
    
    ✔ Successfully built cell image: <CELLERY_HUB_ORG>/pet-be-composite:0.6.0
    
    What's next?
    --------------------------------------------------------
    Execute the following command to run the image:
      $ cellery run <CELLERY_HUB_ORG>/pet-be-composite:0.6.0
    --------------------------------------------------------

    $ cellery build pet-fe-cell-to-composite.bal <CELLERY_HUB_ORG>/pet-fe-cell-to-composite:0.6.0
    Hello World Cell Built successfully.
    
    ✔ Building image <CELLERY_HUB_ORG>/pet-fe-cell-to-composite:0.6.0
    ✔ Saving new Image to the Local Repository
    
    
    ✔ Successfully built cell image: <CELLERY_HUB_ORG>/pet-fe-cell-to-composite:0.6.0
    
    What's next?
    --------------------------------------------------------
    Execute the following command to run the image:
      $ cellery run <CELLERY_HUB_ORG>/pet-fe-cell-to-composite:0.6.0
    --------------------------------------------------------
...
```
$ cellery run wso2cellery/pet-fe-cell-to-composite:0.6.0 -n pet-fe-comp-cell -l petStoreBackend:pet-be-comp -d
  ✔ Extracting Cell Image wso2cellery/pet-fe-cell-to-composite:0.6.0
  ✔ Reading Image wso2cellery/pet-fe-cell-to-composite:0.6.0
...
------------------------------------------------------------------------------------------------------------------------
pet-be-comp       wso2cellery/pet-be-composite:0.6.0              To be Created     Composite      -              
pet-fe-comp-cell  wso2cellery/pet-fe-cell-to-composite:0.6.0      To be Created     Cell           -              
------------------------------------------------------------------------------------------------------------------------
  ...
  ✔ Successfully deployed cell image: wso2cellery/pet-fe-cell-to-composite:0.6.0
...
```
 ...
 ------------------ ------------------------------------------- ----- --------------------------------- ------------ -------
  pet-fe-comp-cell  wso2cellery/pet-fe-cell-to-composite:0.6.0 Ready pet-fe-comp-cell--gateway-service     1       45 seconds 
 
 Composite Instances:
   INSTANCE                 IMAGE                    STATUS   COMPONENTS      AGE      
 ------------- ------------------------------------ -------- ------------ ------------ 
  pet-be-comp   wso2cellery/pet-be-composite:0.6.0   Ready    4            1 minutes   
...
4. Execute `cellery view` to see the components of the composite. This will open a webpage in a browser that allows to visualize the components of the composite image.
    ```
    $ cellery view <CELLERY_HUB_ORG>/pet-fe-cell-to-composite:0.6.0
    ```
